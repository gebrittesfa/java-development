...
public class UserInterface {
   ...
   /* private Dealership userFace() {
    ...
    public void display() {
        ...
        System.out.println("9. Record a sales");
...
//    List<Vehicle> processRecordSaleRequest(){
//
//    }
//
//
//    List<Vehicle> processRecordLeaseRequest(){
//
//    }
...
//    }
    List<Vehicle> processRecordSaleRequest() {
        //method that processes a sale request
//        private void processRecordSaleRequest() {
        Scanner scanner = new Scanner(System.in);
        ...
        Sale sale = new Sale(vehicleVin, customerName, customerAddress, customerPhone, saleDate, salePrice);
        SalesDao salesDao;
    ...
    List<Vehicle> processRecordLeaseRequest(){
        //  method that processes a lease request
//        private void processRecordLeaseRequest() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter Vehicle VIN: ");
        String vehicleVin = scanner.nextLine();
        System.out.println("Enter Lease Start Date (yyyy-mm-dd): ");
        LocalDate leaseStartDate = LocalDate.parse(scanner.nextLine());
        System.out.println("Enter Lease End Date (yyyy-mm-dd): ");
        LocalDate leaseEndDate = LocalDate.parse(scanner.nextLine());
        System.out.println("Enter Monthly Payment: ");
        double monthlyPayment = scanner.nextDouble();
        Lease lease = new Lease(Vehicle VIN, leaseStartDate, leaseEndDate, monthlyPayment);
