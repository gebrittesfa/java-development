...
public class LambdaExpressions {
    public static void main(String[] args) {
        ...
        System.out.println("Matching last name: "+matchingPersons);
        ...
        List<String> sortedMovies = titles.stream().filter(title -> title.toLowerCase().contains("halloween"))
                .sorted().toList();
...
// get list of unique squares
        List<Integer> squaresList = numbers.stream().map(num -> num * num)
        ...
        // this is the initial value of temp0,
        // temp holds the aggregation as all numbers are added
