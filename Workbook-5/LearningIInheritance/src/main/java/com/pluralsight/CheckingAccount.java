...
public class CheckingAccount {
    ...
    public CheckingAccount(String owner, String accountName, int accountNumber, double initialDeposit, LocalDate dateOpened,
                           long routingNo, double interestOwed, double minimumBalance){
